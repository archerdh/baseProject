...
@interface TBCameraController ()<AVCaptureFileOutputRecordingDelegate>
...
@implementation TBCameraController
...
- (void)routeView
{
    AVCaptureConnection *output2VideoConnection = [self.movieOutput connectionWithMediaType:AVMediaTypeVideo];
    output2VideoConnection.videoOrientation = [self currentVideoOrientation];
}
