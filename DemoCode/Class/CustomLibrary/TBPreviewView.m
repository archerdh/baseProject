...
- (void)routeView
{
    AVCaptureVideoPreviewLayer *prewLayer = (AVCaptureVideoPreviewLayer *)self.layer;
    prewLayer.connection.videoOrientation = [self currentVideoOrientation];
}
